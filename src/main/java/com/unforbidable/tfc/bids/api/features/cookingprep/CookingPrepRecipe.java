...
public class CookingPrepRecipe implements SimpleRecipeMatcher<ItemStack[]> {

    public static final int INGREDIENT_COUNT = 5;
    private static final float REQUIRED_WEIGHT_TOLERANCE = 0.95f;

    protected final ItemStack output;
    private final CookingPrepIngredientSpec[] ingredients;
    private final float minWeight;

    public CookingPrepRecipe(ItemStack output, CookingPrepIngredientSpec ...ingredients) {
        this(output, 0, ingredients);
    }

    public CookingPrepRecipe(ItemStack output, float minWeight, CookingPrepIngredientSpec ...ingredients) {
    ...
    public CookingPrepIngredientSpec[] getIngredients() {
        return ingredients;
    }
    ...
    private boolean doesAnyIngredientMatch(ItemStack is) {
        for (CookingPrepIngredientSpec ingredient : ingredients) {
