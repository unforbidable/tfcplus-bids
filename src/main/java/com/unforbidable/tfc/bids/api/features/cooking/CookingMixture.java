...
public class CookingMixture {
    ...
    public ItemStack asItemStack() {
        return CookingMixtureHelper.createCookingMixtureItemStack(name);
    }

    public FluidStack asFluidStack(int volume) {
        return CookingMixtureHelper.createCookingMixtureFluidStack(name, volume);
    }
