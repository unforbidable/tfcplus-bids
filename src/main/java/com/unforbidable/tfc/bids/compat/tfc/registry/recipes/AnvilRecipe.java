...
public class AnvilRecipe {
    ...
    public AnvilRecipe(ItemStack input, ItemStack input2, String plan, int req, ItemStack output, String skill) {
        this.input = input;
        this.input2 = input2;
        this.plan = plan;
        this.req = req;
    ...
    public static RegistryActor<AnvilRecipe> add(ItemStack input, ItemStack input2, String plan, int req, ItemStack output, String skill) {
        return new RegistryAddingActor<>(AnvilRecipeStage.instance, new AnvilRecipe(input, input2, plan, req, output, skill));
    }
