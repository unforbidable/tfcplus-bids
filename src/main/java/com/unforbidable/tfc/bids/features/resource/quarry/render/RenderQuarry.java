package com.unforbidable.tfc.bids.features.resource.quarry.render;
...
import com.unforbidable.tfc.bids.features.resource.quarry.main.QuarryWedgeBounds;
import com.unforbidable.tfc.bids.features.resource.quarry.main.QuarryWedgeModeller;
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        for (QuarrySideWedgeData data : quarry.getWedges()) {
            ...
            for (ItemStack wedge : data.storage) {
                Block wedgeBlock = ((PlugAndFeather)wedge.getItem()).getPlugAndFeatherRenderBlock(wedge);
                int wedgeMetadata = ((PlugAndFeather)wedge.getItem()).getPlugAndFeatherRenderBlockMetadata(wedge);
