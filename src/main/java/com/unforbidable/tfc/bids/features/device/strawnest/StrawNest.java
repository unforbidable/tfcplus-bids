...
public class StrawNest extends Feature {
    ...
    public void init(FeatureInitSpecBuilder init, FeatureRegistryLookup lookup) {
        init.block(BlockNames.STRAW_NEST, BlockStrawNest::new)
            .fireInfo(5, 5);

        init.tileEntity(TileEntityStrawNest.class, "BidsStrawNest");

        init.gui(BlockNames.STRAW_NEST, ContainerStrawNest::new);
    }
    ...
    public void client(FeatureClientSpecBuilder client) {
        ...
        client.gui(BlockNames.STRAW_NEST, GuiStrawNest::new);
    }
