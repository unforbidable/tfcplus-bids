    ...
    public void setup(FeatureSetupBuilder setup) {
        ...
        setup.registry(TfcRegistry.Barrel.recipes)
            .add(BarrelRecipe.addItemDemanding(builder -> builder
                .consumes(new ItemStack(TFCItems.powder, 1, PowderMeta.ASH), new FluidStack(TFCFluids.FRESHWATER, 200))
        ...
        setup.registry(CookingRegistry.recipes)
            .add(CookingRecipe.builder()
                .consumes(new FluidStack(TFCFluids.FRESHWATER, 200), new ItemStack(TFCItems.powder, 1, PowderMeta.ASH))
                .produces(new FluidStack(BidsFluids.weakWoodAshLye, 200))
                .inFixedTime(20000)
                .build())
            .add(CookingRecipe.builder()
