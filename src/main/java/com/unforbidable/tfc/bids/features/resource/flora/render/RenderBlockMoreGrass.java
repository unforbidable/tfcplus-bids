...
public class RenderBlockMoreGrass implements ISimpleBlockRenderingHandler
{
	@Override
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ...
        //((RenderBlocksWithRotation) renderer).drawCrossedSquares(iicon, x, y, z, 1f, 2);

        renderBlockCropsImpl(block, x, y, z, renderer, 0.5, 1);
