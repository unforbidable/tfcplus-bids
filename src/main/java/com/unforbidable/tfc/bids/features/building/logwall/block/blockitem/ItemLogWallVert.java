...
public class ItemLogWallVert extends ItemBlock implements ISize {

    private String[] names = null;

    public ItemLogWallVert(Block block) {
        super(block);
    ...
    public String getUnlocalizedName(ItemStack is) {
        ...
        String name = getUnlocalizedName().replace("Alt", "");
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        world.setBlock(x, y, z, LogWallHelper.getLogWallVertBlock(getOffset(), side, player.isSneaking()), metadata, 2);
        return true;
    }
