...
public class BlockMudbrickChimney extends BlockContainer {
    ...
    public BlockMudbrickChimney(int stoneOffset) {
    ...
    public BlockMudbrickChimney setDirt(Block dirt) {
    ...
    public TileEntity createNewTileEntity(World arg0, int arg1) {
        return new TileEntityMudBrickChimney();
    }
