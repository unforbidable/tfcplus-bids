package com.unforbidable.tfc.bids.features.device.dryingrack.tileentity;
...
public class TileEntityDryingRack extends TileEntity implements IInventory, PacketHandler<SimpleUpdatePacket>, DryingHost {
    ...
    private ItemStack findAndConsumeOneTyingEquipment(EntityPlayer player, Item item) {
