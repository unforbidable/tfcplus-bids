package com.unforbidable.tfc.bids.features.building.mudbrick.block.itemblock;
...
public class ItemMudbrickChimney extends ItemBlock implements ISize {

    public ItemMudbrickChimney(Block block) {
        super(block);
    }
    ...
    public String getUnlocalizedName(ItemStack is) {
        ...
        if (block instanceof BlockMudbrickChimney) {
            int dmg = is.getItemDamage() + ((BlockMudbrickChimney) block).getStoneOffset();
    ...
    public void addInformation(ItemStack is, EntityPlayer player, List arraylist, boolean flag) {
        ...
        if (b instanceof BlockMudbrickChimney) {
