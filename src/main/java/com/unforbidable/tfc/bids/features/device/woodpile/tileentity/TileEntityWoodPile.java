package com.unforbidable.tfc.bids.features.device.woodpile.tileentity;
...
public class TileEntityWoodpile extends TileEntity implements IInventory, PacketHandler<WoodpilePacket>, IHeatSourceTE {
    ...
    public void updateEntity() {
        if (!worldObj.isRemote) {
            ...
            if (openDelayedGUIplayer != null) {
                GuiUtil.openGui(BlockNames.WOODPILE, openDelayedGUIplayer, this);
    ...
    private void handleBurningItem(WoodpileBurningItem burningItem, EnumBurningRate burningRate) {
        ...
        if (ticksNeededToBurnItemForBurningRate <= ticksSincePreviousLogBurning) {
            ...
            kiLnEngine.updateProgress(lastKilnProgress, currentKilnProgress);
