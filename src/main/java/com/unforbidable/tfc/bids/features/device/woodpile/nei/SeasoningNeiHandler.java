package com.unforbidable.tfc.bids.features.device.woodpile.nei;
...
public class SeasoningNeiHandler extends TemplateRecipeHandler implements IHandlerInfoProvider {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals(HANDLER_ID) && getClass() == SeasoningNeiHandler.class) {
            for (SeasoningRecipe recipe : WoodpileRegistry.seasoning) {
    ...
    public class CachedSeasoningRecipe extends CachedRecipe {
        ...
        public String getDurationString() {
            final int hours = (int) (duration * WoodpileConfig.seasoningDurationMultiplier);
