package com.unforbidable.tfc.bids.features.resource.quarry.nei;
...
public class QuarryNeiHandler extends TemplateRecipeHandler implements IHandlerInfoProvider {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals(HANDLER_ID) && getClass() == QuarryNeiHandler.class) {
            loadRecipes(null);
        } else {
    ...
    private void loadRecipes(ItemStack result) {
        for (Quarriable quarriable : QuarryRegistry.quarriable) {
