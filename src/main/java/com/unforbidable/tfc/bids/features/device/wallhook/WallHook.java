package com.unforbidable.tfc.bids.features.device.wallhook;
...
public class WallHook extends Feature {
    ...
    public void client(FeatureClientSpecBuilder client) {
        client.render(new RenderWallHook())
            .block(BlockWallHook.class);

        client.render(new RenderTileWallHook())
            .tileEntity(TileEntityWallHook.class);
    }

    @Override
    public void setup(FeatureSetupBuilder setup) {
        setup.recipes().addShapeless(new ItemStack(BidsBlocks.wallHook),
