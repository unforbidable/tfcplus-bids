package com.unforbidable.tfc.bids.features.crafting.firestarting.render;
...
public class TinderItemRenderer implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
        ...
        if (FireStartingHelper.isTinderLit(is)) {
            final float progress = Math.max(0, FireStartingHelper.getTinderSmolderingProgress(is));
            final float progressWidth = progress * 13.0F;

            renderQuad(1, 14, 14, 1, 0);
            renderQuad(1, 14, progressWidth, 1, 0xffdd0000);
        }
