package com.unforbidable.tfc.bids.features.resource.crop.worldgen;
...
public class CropWorldGen implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        CropChunkData data = ChunkData.of(world, chunkX, chunkZ)
            .get(CropChunkData.class);
        data.lastSpringGenYear = TFC_Time.getYear();
