...
public class CropBuilder {
    ...
    public CropBuilder generates(EnumRegion[] regions, int minimumNaturalRain, int maximumNaturalRain, int minimumNaturalBioTemp, int maximumNaturalBioTemp, CropCoastAffinity coastal) {
