...
public class WoodIndex {
    ...
    public final boolean hasBarkFlammable;
    ...
    public WoodIndex(int index, String name, int maxBurnTemp, int maxBurnTime, int tasteProfile, boolean hasBark, boolean hasBarkFibers, boolean hasBarkTannin, boolean hasBarkFlammable, boolean hasLargeLogs, boolean hardwood, boolean resinous, boolean inflammable) {
        this.index = index;
        this.name = name;
        ...
        this.hasBarkFlammable = hasBarkFlammable;
