package com.unforbidable.tfc.bids.core.crop.render;
...
public class CropRenderer {
    ...
    protected final CropRenderType renderType;
    ...
    public CropRenderer(CropRenderType renderType, double width, double height, String blockIconName) {
