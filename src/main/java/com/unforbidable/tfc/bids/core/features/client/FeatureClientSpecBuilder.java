...
import com.unforbidable.tfc.bids.core.features.client.render.RenderEntityBuilder;
...
public class FeatureClientSpecBuilder {
    ...
    private final List<RenderEntityBuilder> entities = new ArrayList<>();
    ...
    public RenderEntityBuilder render(Render renderer) {
        RenderEntityBuilder builder = new RenderEntityBuilder(renderer);
