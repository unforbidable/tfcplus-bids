...
public class CropIds {
    ...
    public static final int ONION = 8;
    public static final int CABBAGE = 9;
    public static final int GARLIC = 10;
    public static final int CARROT = 11;

    public static final int SEABEET = 1000;
