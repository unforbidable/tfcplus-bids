...
//        flatGlass = new ItemCommonFlat().setUnlocalizedName("Flat Glass");
...
//        igInStoneDrillHead = new ItemCommonToolHead(TFCItems.igInToolMaterial)
//            .setUnlocalizedName("IgIn Stone Drill Head");
//        sedStoneDrillHead = new ItemCommonToolHead(TFCItems.sedToolMaterial)
//            .setUnlocalizedName("Sed Stone Drill Head");
//        igExStoneDrillHead = new ItemCommonToolHead(TFCItems.igExToolMaterial)
//            .setUnlocalizedName("IgEx Stone Drill Head");
//        mMStoneDrillHead = new ItemCommonToolHead(TFCItems.mMToolMaterial)
...
//        igInStoneAdzeHead = new ItemCommonToolHead(TFCItems.igInToolMaterial)
//            .setUnlocalizedName("IgIn Stone Adze Head");
//        sedStoneAdzeHead = new ItemCommonToolHead(TFCItems.sedToolMaterial)
//            .setUnlocalizedName("Sed Stone Adze Head");
//        igExStoneAdzeHead = new ItemCommonToolHead(TFCItems.igExToolMaterial)
//            .setUnlocalizedName("IgEx Stone Adze Head");
//        mMStoneAdzeHead = new ItemCommonToolHead(TFCItems.mMToolMaterial)
...
//        copperAdzeHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Copper Adze Head");
//        bronzeAdzeHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Bronze Adze Head");
//        bismuthBronzeAdzeHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Bismuth Bronze Adze Head");
//        blackBronzeAdzeHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Black Bronze Adze Head");
//        wroughtIronAdzeHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Wrought Iron Adze Head");

//        copperDrillHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Copper Drill Head");
//        bronzeDrillHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Bronze Drill Head");
//        bismuthBronzeDrillHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Bismuth Bronze Drill Head");
//        blackBronzeDrillHead = new ItemCommonToolHead()
//            .setUnlocalizedName("Black Bronze Drill Head");
//        wroughtIronDrillHead = new ItemCommonToolHead()
...
//        birchBarkSheet = new ItemCommonClothSheet().setSpecialCraftingType(flatBirchBark)
//            .setUnlocalizedName("Birch Bark Sheet");
//        birchBarkRepairPatch = new ItemExtraClothingPiece().setExtraPieceTypes(ExtraClothingMaterialNames.BIRCH_BARK)
//            .setUnlocalizedName("Repair Patch");
//        birchBarkBagPiece = new ItemExtraClothingPiece().setExtraPieceTypes(ExtraClothingMaterialNames.BIRCH_BARK)
//            .setUnlocalizedName("Bag Piece");
//        birchBarkStrap = new ItemExtraClothingPiece().setExtraPieceTypes(ExtraClothingMaterialNames.BIRCH_BARK)
//            .setUnlocalizedName("Strap");
//        birchBarkCupPiece = new ItemExtraClothingPiece().setExtraPieceTypes(ExtraClothingMaterialNames.BIRCH_BARK)
//            .setUnlocalizedName("Cup Piece");
//        birchBarkBag = new ItemExtraBag().setMaxDamage(12)
//            .setUnlocalizedName("Birch Bark Bag");
//        birchBarkCupUnfinished = new ItemCommonSewable()
...
//            .setExtraPieceTypes(ExtraClothingMaterialNames.LEATHER)
