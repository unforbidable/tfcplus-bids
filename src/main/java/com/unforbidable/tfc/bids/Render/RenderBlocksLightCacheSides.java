...
public class RenderBlocksLightCacheSides extends RenderBlocksFixUV {

    public RenderBlocksLightCacheSides(RenderBlocks old) {
        super(old);
    }
	...
	*/
	...
	public void renderCachedBlock(Block block, int i, int j, int k, RenderIconProvider icons)
	{
		...
		renderFaceXPos(block, i, j, k, icons.getIcon(ForgeDirection.EAST.ordinal()));
		...
		renderFaceXNeg(block, i, j, k, icons.getIcon(ForgeDirection.WEST.ordinal()));
		...
		renderFaceZPos(block, i, j, k, icons.getIcon(ForgeDirection.SOUTH.ordinal()));
		...
		renderFaceZNeg(block, i, j, k, icons.getIcon(ForgeDirection.NORTH.ordinal()));
		...
		renderFaceYPos(block, i, j, k, icons.getIcon(ForgeDirection.UP.ordinal()));
		...
		renderFaceYNeg(block, i, j, k, icons.getIcon(ForgeDirection.DOWN.ordinal()));
